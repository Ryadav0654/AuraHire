    ...
    <section className="relative pt-16 pb-32 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          {/* Badge */}
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border border-gray-400 dark:border-slate-700 mb-8">
          ...
          <div className="relative">
            <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-md rounded-4xl p-6 border border-gray-200 dark:border-slate-700 shadow-2xl">
              <img
                src="/hero.png"
                alt="Hero"
